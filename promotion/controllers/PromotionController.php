...
class PromotionController extends BackendController
{
     ...
     *     @OA\Property(property="condition_type", type="integer", description="促销条件类型 1全部商品2商品分类3部分商品4订单满减"),
     *     @OA\Property(property="condition", type="string", description="促销条件"),
     *     @OA\Property(property="content", type="string", description="促销内容"),
     *     @OA\Property(property="result_type", type="integer", description="促销结果类型 1:商品减固金额2:商品折扣3:商品一口价4:订单减固定金额5:订单折扣6:订单一口价"),
