<?php
namespace bricksasp\rbac\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use bricksasp\rbac\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\bricksasp\rbac\models\Menu]].
 * 
